...
admin.add_relation(sender_id=8, receiver_id=4, weight=users.relation.Friend)
...
admin.add_relation(sender_id=9, receiver_id=5, weight=users.relation.Friend)
admin.accept_relation(9, 5)

admin.add_relation(sender_id=6, receiver_id=11, weight=users.relation.Friend)
admin.accept_relation(6, 11)

admin.add_relation(sender_id=7, receiver_id=12, weight=users.relation.Friend)
...
admin.add_relation(sender_id=14, receiver_id=9, weight=users.relation.Friend)
admin.accept_relation(14, 9)

admin.add_relation(sender_id=10, receiver_id = 15, weight = users.relation.Parent)
...
admin.add_relation(sender_id=18, receiver_id=24, weight=users.relation.Sibling)
...
admin.add_relation(sender_id=25, receiver_id=29, weight=users.relation.Friend)
...
admin.add_relation(sender_id=38, receiver_id=28, weight=users.relation.Friend)
admin.accept_relation(38, 28)

admin.add_relation(sender_id=39, receiver_id=29, weight=users.relation.Friend)
...
admin.add_relation(sender_id=34, receiver_id=35, weight=users.relation.Friend)
...
admin.Posts[0].add_comment("I'm selfish, impatient and a little insecure. I make mistakes,"
                           " I am out of control and at times hard to handle. But if you can't handle me at my worst,"
                           " then you sure as hell don't deserve me at my best", 6)
...
admin.Posts[5].add_comment("Two things are infinite: the universe and human stupidity;"
                           "and I'm not sure about the universe", 13)
...
admin.Posts[9].add_comment("Be who you are and say what you feel,"
                           " because those who mind don't matter, and those who matter don't mind", 22)
...
admin.Posts[15].add_comment("You know you're in love when you can't fall asleep"
                            " because reality is finally better than your dreams", 35)
...
admin.Posts[19].add_comment("You miss 100% of the shots you don’t take", 40)
admin.Posts[19].add_comment("In three words I can sum up everything I've learned about life: it goes on", 43)
print(admin.num_posts)

admin.add_post(post.Post("The mind is everything. What you think you become", 20), 20 )
admin.Posts[20].add_comment("Dream big and dare to fail", 39)
admin.Posts[20].add_comment("If you want to know what a man's like,"
...
admin.Posts[21].add_comment("Tough times never last, but tough people do", 32)
admin.Posts[21].add_comment("Don’t walk in front of me… I may not follow Don’t walk behind me… I may not lead Walk beside me… just be my friend", 30)
print(admin.num_posts)

admin.add_post(post.Post("Live each day as if your life had just begun", 29), 29 )
admin.Posts[22].add_comment("Education costs money. But then so does ignorance", 27)
